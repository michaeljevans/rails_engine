...
RSpec.describe 'Revenue API' do
  it 'can return total revenue for all merchants between given dates' do
    ...
    get '/api/v1/revenue?start=2020-08-21&end=2020-08-29'
    ...
    expect(revenue_response[:data][:attributes][:revenue]).to eq(4355.75)
  end
end
